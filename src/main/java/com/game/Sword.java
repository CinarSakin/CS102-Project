...
public class Sword extends Weapon {
    ...
    //    Dimension hitBox = new Dimension(heroPos.getX() + 20, heroPos.getY(), 30, 30);
        ...
        Point2D spawnPos = heroPos.add(lastDir.multiply(Drawer.gridSize * 0.4));

        Projectile p = new Projectile(
            Projectile.ProjectileType.SLASH, TargetType.ENEMIES, spawnPos, lastDir, attackSpeed, Hero.getHero().currentArea
        );
